...
<div class="row">
    ...
    <div class="col-sm-7">
        <div class="form-group{{ $errors->has('municipal_registration') ? ' has-danger' : '' }}">
            <input class="form-control{{ $errors->has('municipal_registration') ? ' is-invalid' : '' }}" name="municipal_registration" id="input-municipal_registration" type="text" placeholder="{{ __('municipal_registration') }}" value="{{ old('municipal_registration', $customer->municipal_registration ?? $customer->typeable->municipal_registration ) }}" required />
...
<div class="row">
    ...
    <div class="col-sm-7">
        <div class="form-group{{ $errors->has('state') ? ' has-danger' : '' }}">
            <input class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" name="state" id="input-state" type="text" placeholder="{{ __('state') }}" value="{{ old('state', $customer->state ?? $customer->typeable->state ) }}" required />
            @if ($errors->has('state'))
