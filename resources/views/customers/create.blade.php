                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group{{ $errors->has('listen_records') ? ' has-danger' : '' }} pull-left">
                              <input class="{{ $errors->has('listen_records') ? ' is-invalid' : '' }}" name="listen_records" id="input-listen_records" type="checkbox" placeholder="{{ __('Listen records') }}" value="1" {{ old('listen_records', $customer->listen_records?'checked':'') }} required="true" aria-required="true"/>
