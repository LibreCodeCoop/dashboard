...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'voip' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_VOIP'),
            'host' => env('DB_HOST_VOIP', '127.0.0.1'),
            'port' => env('DB_PORT_VOIP', '3306'),
            'database' => env('DB_DATABASE_VOIP', 'forge'),
            'username' => env('DB_USERNAME_VOIP', 'forge'),
            'password' => env('DB_PASSWORD_VOIP', ''),
            'unix_socket' => env('DB_SOCKET_VOIP', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
